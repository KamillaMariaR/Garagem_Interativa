// js/main.js (VERSÃO FINAL COM CLIMA E DICAS COMPLETOS)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function handleAdicionarVeiculo(event) {
        ...
        const btnSubmit = form.querySelector('#btn-submit-veiculo');
        const errorMessageDiv = form.querySelector('#form-error-message');
        const veiculoData = {
            placa: form.querySelector('#input-placa').value,
            marca: form.querySelector('#input-marca').value,
            modelo: form.querySelector('#input-modelo').value,
            ano: form.querySelector('#input-ano').value,
            cor: form.querySelector('#input-cor').value,
        };
    ...
    // =============================================================
    // === SEÇÃO DE PREVISÃO DO TEMPO (CLIMA - COMPLETA) ===
    // =============================================================
    ...
    document.getElementById('tbody-veiculos')?.addEventListener('click', (event) => {
        if (event.target.classList.contains('btn-delete')) {
            handleDeletarVeiculo(event.target.dataset.id, event.target.dataset.placa);
        }
    });
